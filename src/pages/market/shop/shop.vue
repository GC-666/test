<template>
	<tm-app>
		...
		<scroll-view scroll-y="true" :class="list.length>0?'scroll-Y':''" @scrolltolower="lower">
			<tm-sheet :shadow="0" :round="4" :margin="[20,20]" :padding="[0,0]" v-for="(item,index) in list"
				...
				<view class="flex flex-between mt-20 ml-20 mr-20">
					<view class="flex flex-row-center-start ">
						...
						<tm-text v-if="item.type=='2'" color="#d29850" _class="text-weight-b ml-10" :fontSize="24"
							label="交易中">
						</tm-text>
					</view>
