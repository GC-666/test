	...
	<tm-app style="">
		...
		<scroll-view scroll-y="true" :class="userCollectionFindPageList.length>0?'scroll-Y':''" @scrolltolower="lower">
			<view style="margin: 0rpx 20rpx 0rpx 20rpx;">
				<view class="" v-for="(data,index) in userCollectionFindPageList"
					...
					<view class="pa-10">
						<tm-sheet :round="4" :shadow="0" :margin="[0,0]" :padding="[20,10]">
							...
							<view class="flex flex-between"
								style="margin:10rpx 10rpx 0rpx 10rpx;padding: 0rpx 0rpx 10rpx 0rpx">
								<view class="flex">
									<tm-text color="#999" :font-size="22" _class="text-weight-b"
										:label="data.collTruenumber">
									</tm-text>
								</view>
								<view class="flex mr-2" v-if="data.type=='1' || data.type=='2' ">
									<tm-text color="#999" :font-size="22" _class="text-weight-n" label="出售价:"></tm-text>
									<tm-text color="#999" :font-size="26" _class="text-weight-b"
										:label="data.sellPrice">
									</tm-text>
								</view>
							</view>
						</tm-sheet>
		...
		<view v-if="userCollectionFindPageList.length<=0" class="flex flex-wrap flex-row-center-center"
