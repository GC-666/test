<template>
	<tm-app>
		...
		<view class="scroll-Y2">
			<tm-sheet :shadow="0" :round="4" :margin="[20,10]" :padding="[20,20]"
				v-for="(data,index) in userAddressList">
				...
				<view class="mt-10 flex flex-between">
					...
					<view class="flex flex-center">
						<tm-text class="mr-20" @click="gonav('pages/my/set/address/addressAdd?type=1&id='+data.id)"
							:font-size="28" label="修改"></tm-text>
		...
		<view class="fixed" style="bottom:20rpx;left: 0;right: 0;">
			<tm-button @click="gonav('pages/my/set/address/addressAdd?type=0')" :margin="[20,0]" form-type="submit"
				:fontSize="38" linearDeep="accent" block label="新增新地址"></tm-button>
		</view>
		<tm-modal :height="320" title="提示" splitBtn okText="确认" v-model:show="show" @ok="submit">
