<template>
	...
	<!-- 	<view class="flex flex-center mt-n15">
		...
		<view class="zhye">
			<view class="flex ma-10">
				<tm-icon :fontSize="25" name="tmicon-qiandai"></tm-icon>
				<tm-text :fontSize="25" label="账户钱包"></tm-text>
			</view>
			...
			<view class="flex ml-10">
				...
				<tm-text :fontSize="50" :label="data.balance"></tm-text>
			</view>
		...
		<view class="yqb">
			<view class="flex ma-10">
				<tm-icon :fontSize="25" name="tmicon-qiandai"></tm-icon>
				<tm-text :fontSize="25" label="云钱包"></tm-text>
			</view>

			<view class="mt-n19">
				<tm-divider color="#fff" :margin="[1,10]"></tm-divider>
			</view>
		...
		<view class="jf">
			<view class="flex ma-10">
				<tm-icon :fontSize="25" name="tmicon-qiandai"></tm-icon>
				<tm-text :fontSize="25" label="积分"></tm-text>
			</view>
			<view class="flex ml-10">
