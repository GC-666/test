		...
		<view class="content botton-radius">
			<view class="content-top">
				...
				<image class="content-top" style="top: 0;" width="100%" height="100%"
					src="/uni_modules/rt-uni-update/static/bg_top.png"></image>
			</view>
			...
			<view class="content-body">
				...
				<view class="footer flex-center">
					<view class="progress-box flex-column" v-if="!updateBtn">
						<progress class="progress" border-radius="35" :percent="percent" activeColor="#07EBFE" show-info
							stroke-width="10" />
					...
					<button class="content-button" style="border: none;color: #fff;" plain @click="confirm"
						v-if="updateBtn">立即升级</button>
				</view>
			</view>

			<image v-if="cancleBtn" class="close-img" src="/uni_modules/rt-uni-update/static/app_update_close.png"
...
<style>
	...
	.content-button {
		...
		background: linear-gradient(to right, #07EBFE, #3da7ff);
	}
